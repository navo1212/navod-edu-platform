...
//       console.log("[v0] First cart item:", cart[0])
//       console.log("[v0] First cart item ID:", cart[0].id)
//       console.log("[v0] First cart item keys:", Object.keys(cart[0]))
...
//       console.log("[v0] Creating checkout session for user:", me.id)

//       const courseId = cart[0].id || (cart[0] as any)._id

//       if (!courseId) {
//         console.error("[v0] No courseId found in cart item:", cart[0])
//         alert("Invalid course in cart. Please try adding it again.")
//         return
//       }
...
//       console.log("[v0] Sending checkout data:", checkoutData)
...
//                 {cart.map((c) => (
//                   <div key={c.id} className="bg-card border rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                {cart.map((c, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <button
                        onClick={() => removeFromCart(c.id || (c as any)._id)}
                        className="p-2 text-muted-foreground hover:text-destructive hover:bg-destructive/10 rounded-lg transition-colors"
                        aria-label="Remove from cart"
                      >
                        <Trash2 className="h-5 w-5" />
